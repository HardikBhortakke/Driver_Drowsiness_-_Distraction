            ...
            if (count == 0):
                ...
                for r in results:
                    ...
                    for box in boxes:
                        ...
                        # put box in cam
                        cv2.rectangle(img_out, (x1, y1), (x2, y2), (255, 0, 255), 3)
                        ...
                        cv2.putText(img_out, classNames[cls], org, font, fontScale, color, thickness)
                        img_out = cv2.resize(img_out, (new_width, new_height))

                if (a == 1):
                    print("Cellphone Detected")
                    n = int(60/skip_frames)
                else:
                    if (n > 0):
                        n -= 1
